...
public class StarStreamsTest {
    ...
    public void shouldBeNearestStarNotInSunsystem() {
        ...
        // when
        Optional<Star> star = starCollection.stream()
                        .filter(s -> !s.getSystem().equals("Sonnensystem"))
                        .min(comparatorDistance);
    ...
    public void shouldBeSortedDistanceList() {
        ...
        // when
        List<Double> distanceList = starCollection.stream()
                        .map(s -> s.getDistance())
    ...
    public void shouldBeAverageStarDistance() {
        ...
        // when
        double average = starCollection.stream()
                        .filter(s -> !s.getSystem().equals("Sonnensystem"))
    ...
    public void shouldBeBuildString() {
        ...
        // when
        String starNames = starCollection.stream()
                        .map(Star::getStarname)
                        .sorted()
